...
*
*    File:         /usr/users/mcsq/Dvme3/bus_fault60.s
*
...
*    1/ 1/93    MCSQ         
*
*    3/ 5/97    MCSQ      This version is for CPU-60. The stack frames for
*                         buss error differ between 68040 and 68060.
******************************************************************************
	SECTION	9
******************************************************************************
*
...
BUS_ERR:
	...
	MOVE.L	$C(SP),D0	;special status word
	MOVE.L	D0,-(SP)
	MOVE.L	$C(SP),D1	;fault address
	MOVE.L	D1,-(SP)
	MOVE.L	$A(SP),D1	;pc
	MOVE.L	D1,-(SP)
	MOVEQ	#0,D0
