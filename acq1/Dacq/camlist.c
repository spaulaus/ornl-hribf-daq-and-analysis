...
*
*    These replace routines in vmelib.a for testing modu_setup.f
*
*    Link lf95 with camlist.o instead of vmelib.a
*
*****************************************************************************/
/*****************************************************************************
   ...
   while (cnt > 0)
    {
      ...
      *status = 0;
      fsave = *ff;
      printf("\nCAMLIST: C,N,A,F,DATA,STAT: %i %i %i %i",*cc++,*nn++,*aa++,*ff++);
      if ((fsave & 0x18) == 0x10)
       {
/*
