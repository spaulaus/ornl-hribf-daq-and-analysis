...
c
c  This code helps to log the event counts for DOE's utterly absurd
c  performance efficiency measure.
      call initdoelog
      write(cmssg,*) '--------DOE Logging Started---------'
      call messlog(logut,logup)
      call doecntlog(mssg,0,0.0,0,0)
