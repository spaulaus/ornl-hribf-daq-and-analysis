...
C
      ...
      integer*4    xtim(6)
C
      EQUIVALENCE (HEDH,HEDF),(titl,ctitl),(hedf(9),datetime)
C
      data ctitl /'ORPHAS data acquisition system'/
C
      DATA HEDN/1/
...
C
  ...
  310 CONTINUE
      call milymdhms(xtim)
      xtim(1) = xtim(1) -2000
      write(datetime,311)xtim(2),xtim(3),xtim(1),xtim(4),xtim(5)
311   format(i2.2,'/',i2.2,'/',i2.2,' ',i2.2,":",i2.2)
