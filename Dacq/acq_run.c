...
extern int h_errno; /* gethostbyaddr error number */
...
int main(int argc, char *argv[])
{
  ...
  while(1) {
    ...
    *outbuf = cmd_code[i];
    ...
    if (*outbuf == HOST) {
      /* The address is 4 bytes, starting in byte 3 of the returned 
         buffer */
      struct hostent *host;
      
      host = gethostbyaddr((const char *)&inbuf[2], sizeof(int), AF_INET);
      if (host != NULL) {
   ...
   switch (error)
    {
      ...
      case  ACQ_INVALID_TABLE:
        printf("Remember to run pacor before initvme.\n");
        break;
      case  ACQ_STR_NOINIT:
      ...
      case  ACQ_NO_CAEN_QDC:
        ...
        break;
      case  ACQ_NO_SIS_SCL:
        printf("One or more SIS scaler modules not found.\n");
        break;
      case  ACQ_NO_MYRIAD:
        printf("The MYRIAD module was not found.\n");
        break;
      case  ETHER_RECEIVE:
      ...
      case  ETHER_OPEN:
        ...
        break;
      case  ETHER_TIMEOUT:
        printf("Ethernet reply timed out.\n");
        break;
       case  ETHER_SEQUENCE:
        printf("Ethernet reply was out of sequence.\n");
        break;
       default:
