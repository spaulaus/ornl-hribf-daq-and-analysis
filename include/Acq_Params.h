...
*   10/20/2017  RLV        Add SIS3820 scaler and MYRIAD
*****************************************************************************/
...
*/
struct tbl_index {
     uint32_t  offset;	/* long word offset from start of parameter ram  */
...
#define  CAEN_792     43      /* CAEN Model 792 QDC        */
#define  SIS_3820     44      /* SIS Model 3820 scaler     */
#define  MYRIAD       45      /* ANL MYRIAD module         */
...
#define INDEX_CAEN_QDC_HARD   28
#define INDEX_CAEN_ADC_ID     29
#define INDEX_CAEN_TDC_ID     30
#define INDEX_CAEN_QDC_ID     31
