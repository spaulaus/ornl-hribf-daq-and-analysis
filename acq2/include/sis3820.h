...
struct SIS3820 {
    ...
    volatile unsigned long dum3[45];
    ...
    volatile unsigned long dum4[60];
    ...
    volatile unsigned long dum5a;
    volatile unsigned long ch_1_17_highbits; /*R   - bits 33-48 of channels 1,17 */
    volatile unsigned long veto_inhibit;     /*R/W - Veto ext cnt inhibit reg */
    volatile unsigned long tst_pulse_msk;    /*R/W - test pulse mask register */
    volatile unsigned long dum6[121];
    ...
    volatile unsigned long dum7[248];
    volatile unsigned long shadow[32];       /* R - shadow registers          */
    volatile unsigned long dum8[96];
