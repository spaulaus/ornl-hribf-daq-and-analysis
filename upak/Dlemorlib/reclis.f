C$PROG RECLIS    - Displays number of records & files written to output
C
C     ******************************************************************
C     BY W.T. MILNER AT HRIBF - LAST MODIFIED 04/24/2002
C     ******************************************************************
C
      SUBROUTINE RECLIS(NRRED)
C
      IMPLICIT NONE
C
C     ------------------------------------------------------------------
...
C
      WRITE(CMSSG,20)NUMINT,NUMOUT(KS),KS
      CALL MESSLOG(LOGUT,LOGUP)
C
