...
C
C     ******************************************************************
C     From J.W. McConnell AT HRIBF - LAST MODIFIED by WTM 04/23/2002
C     ******************************************************************
C
C     ==================================================================
...
C
      INTEGER*4    MXZOT,NZOT,BNDX,DATA,ID,LO,HI,I,J
C
      DATA         MXZOT,NZOT,BNDX/0,0,1/
C
      CHARACTER*4  DONE
C
      SAVE
...
C                                         !Otherwise,
      ...
      EXPEV(ID)=IAND(DATA,int(Z'FFFF'))        !Save DATA in event-buffer
