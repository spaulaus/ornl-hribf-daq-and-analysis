C$PROG COMMAKE   - Builds Mass-Excess DATA statement for MASSEX
C
      INTEGER*4 MASS(4),ERR(4),LOZ(120),HIZ(120)
C
      INTEGER*4 A(9,3180)
C
      DATA LOZ,HIZ/240*0/
...
C
      HIZ(NDX)=NN
C
C     WRITE(7,777)NN,IZ,IA,MASS,ERR
C 777 FORMAT(3I8,2(3A4,A3))
C
      A(1,NN)=IA
      DO 130 I=1,4
      A(I+1,NN)=MASS(I)
