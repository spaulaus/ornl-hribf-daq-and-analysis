C$PROG PFIND     - Peak find routine
C
C     ******************************************************************
C     BY J.D. Larson AT HRIBF - LAST MODIFIED 06/18/2002 - for gnu
C     ******************************************************************
C
      SUBROUTINE PFIND(DATA,CHANX,PSIZE,N1,N2,IFWHM,SIGMA,MAXPK,NPK)
C
      INTEGER*4 DATA,CTR,WINGS
C
      DIMENSION DATA(*),CHANX(*),PSIZE(*)
C
      SAVE
C
C     ------------------------------------------------------------------
