...
C
   10 FORMAT(1H ,9('--------'),'-------')
   15 FORMAT(1H ,'All stopping powers are in units of MeV*CMSQ/MG')
...
C
  180 FORMAT(1H ,'Display-solid-line   = ZIEGL  (electronic)')
  190 FORMAT(1H ,'Display-open-circle  = WARZIG (electronic)')
  200 FORMAT(1H ,'Display-close-circle = NORTH  (electronic)')
C
      END
