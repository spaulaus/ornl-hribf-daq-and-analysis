...
#define  LT        "/usr/acq/vme/lt"
#define  BOOTVME   "/usr/acq/vme/bootvme"
#define  LOADACQ   "/usr/acq/vme/loadacq"
#define  LOADDSSD  "/usr/acq/vme/loadDSSD"
#define  STARTVME  "/usr/acq/vme/startvme"
#define  STOPVME   "/usr/acq/vme/stopvme"
#define  STATVME   "/usr/acq/vme/statvme"
#define  TESTVME   "/usr/acq/vme/testvme"
#define  PACFILE   "/usr/acq/vme/pacfile"
#define  INITVME   "/usr/acq/vme/initvme"
#define  SETUP     "/usr/acq/vme/setup"
#define  ZEROCLK   "/usr/acq/vme/zeroclk"
#define  VMEHARDWARE "/usr/acq/vme/vmehardware"
#define  VMEHOST   "/usr/acq/vme/vmehost"
#define  VMECPUS   "/usr/acq/vme/vmecpus"
#define  KT        "/usr/acq/vme/kt"
#define  PRIORITY  "/usr/acq/etc/acq_priority"
#define  HELPFILE  "/usr/acq/wks/pacman.hep"
#define  DOCFILE   "/usr/hhirf/wks/doc/pacmanII.doc"
#define  FIGFILE   "/usr/acq/wks/pacman.fig"
...
#else
#define WHO        "/nfs_home/varner/Acq-development/hribf/mcsq"
#endif

#define  LOGGER    WHO"/Dwks/logger"
#define  XTAPE     WHO"/Dwks/Dtape/tape"
#define  FEMSG     WHO"/Dwks/femsg"
#define  PFTOIPC   WHO"/Dwks/pftoipc"
#define  LT        WHO"/Dvme/lt"
#define  BOOTVME   WHO"/Dvme/bootvme"
#define  LOADACQ   WHO"/Dvme/loadacq"
#define  LOADDSSD  WHO"/Dvme/loadDSSD"
#define  STARTVME  WHO"/Dvme/startvme"
#define  STOPVME   WHO"/Dvme/stopvme"
#define  STATVME   WHO"/Dvme/statvme"
#define  TESTVME   WHO"/Dvme/testvme"
#define  PACFILE   WHO"/Dvme/pacfile"
#define  INITVME   WHO"/Dvme/initvme"
#define  SETUP     WHO"/Dvme/setup"
#define  ZEROCLK   WHO"/Dvme/zeroclk"
#define  VMEHARDWARE WHO"/Dvme/vmehardware"
#define  VMEHOST   WHO"/Dvme/vmehost"
#define  VMECPUS   WHO"/Dvme/vmecpus"
#define  KT        WHO"/Dvme/kt"
#define  PRIORITY  "/usr/acq/etc/acq_priority"
#define  HELPFILE  "/usr/users/mcsq/Dwks/wks/pacman.hep"
#define  DOCFILE   "/usr/hhirf/wks/doc/pacmanII.doc"
#define  FIGFILE   "/usr/acq/wks/pacman.fig"
#define  PRTDOC    "/usr/hhirf/dodoc pacmanII"
...
struct cmdlst kcmd[100] = {
       ...
       "cmd",       EQU,  0,     "cmdf",
       "hup",       HUP,     NOLOG, NULL,
       "pac",       PAC,     LOG,   "/usr/acq/wks/pacor",
       "pacc",      PAC,     LOG,   "/usr/acq/wks/pacor",
       "pacor",     PAC,     LOG,   "/usr/acq/wks/pacor",
 ...
 80x50+10+10 -sb -e vi",
       ...
       "time",      EQU,  0,      "date",
       "pwd",       EXEC, NOLOG,  "pwd",
       "dir",       DIR,  NOLOG,  "/usr/acq/wks/xdir",
       "ls",        EQU, 0,       "dir",
...
char pacpidfile[80];
volatile pid_t  tapepid,loggerpid,femsgpid,pftoipcpid;
...
/*
*   Test for existence of the EXPT name
*/
   if ((cptr = getenv("EXPT")) == NULL || (*cptr == 0))
     {
       printf("\n\
 You MUST set the environment variable EXPT to the name of the\n\
 experiment in progress.\n\n\
 If you are not doing an experiment, set the variable to \"TEST\".\n\n\
 Type:  setenv EXPT rib###\n\
   or   setenv EXPT TEST\n\n");
       return;
     }
/*
...
printf("pftoipc = %i, scan = %i\n",pftoipcpid,scanpid);
***********/

  pid = tapepid + pftoipcpid + loggerpid + femsgpid;
  if (pid)
    {
...
*/
   ...
   cmdlog();
   strcpy(args,"**** Pftoipc Process: ");
   strcat(args,pftoipcfile);
   cmdlog();
/*
*  Start the pftoipc process and the tape process
*/
   pftoipcpid = spawn(pftoipc);
   tapepid = spawn(tape);
/*
...
*/
   ...
   sleep(3);
/*
*   Set priority of the pftoipc process and the TAPEOU process
*/
   uxargs[0] = priority;
   uxargs[1] = pid;
   uxargs[2] = pri_pftoipc;
   uxargs[3] = NULL;
   sprintf(pid,"%i",pftoipcpid);
   exec_wait(uxargs);
   uxargs[2] = pri_tape;
...
*
*   All of this is so that other processes and control the tape if needed.
*/
...
void kill_all(void)
{
   ...
   if (pftoipcpid != 0) kill(pftoipcpid,SIGTERM);
   while(femsgpid+tapepid+pftoipcpid)
    {
...
*/
          ...
          case 7:
/*
*   User specified "pftoipc" process
*/
            cptr = getfield(args,cptr,sizeof(pftoipcfile));
            if (cptr != NULL) strcpy(pftoipcfile,args);
            else
              {
                printf("FIG ERROR: missing filename\n***%s",args);
                ierr = 1;
